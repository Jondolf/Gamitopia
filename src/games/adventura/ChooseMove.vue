...
export default defineComponent({
  ...
  props: {
    ...
    ironSword: { type: Melee, required: true },
    fireScroll: { type: Magic, required: true },
    waterScroll: { type: Magic, required: true },
    iceScroll: { type: Magic, required: true },
    earthScroll: { type: Magic, required: true },
    airScroll: { type: Magic, required: true },
    lightningScroll: { type: Magic, required: true },
    healScroll: { type: Magic, required: true }
  },
