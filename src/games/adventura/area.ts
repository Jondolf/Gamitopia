import {
  Boss,
  EvilKing,
  GiantIceCube, KingSlime,
  MummifiedPharaoh
} from '@/games/adventura/boss';
import {
  BlueSlime,
  CaveBat, Enemy,
  EvilPenguin, FireOrb, FireSlime, FloatingEye,
  ForestOrb, ForestSlime,
  IceOrb, JackOLantern, Mummy,
  RedWizard, RoyalKnight, Skeleton,
  Snowman, SpookyGhost, Vampire, WanderingZombie
} from './enemy';
