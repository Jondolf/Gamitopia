...
import ChooseMove from '@/games/adventura/ChooseMove.vue';
import GetItem from '@/games/adventura/getItem.vue';
import DeathScreen from '@/games/adventura/deathScreen.vue';
import { Melee } from '@/games/adventura/melee';
import { Magic } from '@/games/adventura/magic';
...
export default defineComponent({
  ...
  props: {
    ...
    coinsLost: { type: Number, required: true },
    playerDead: { type: Boolean, required: true },
    getNewEnemy: { type: Boolean, required: true },
    resetTurn: { type: Boolean, required: true },
    damageReceived: { type: [Number, String], required: true },
    damageInflicted: { type: [Number, String], required: true },
    hasHealed: { type: Boolean, required: true },
    currentArea: { type: Object as () => Area, required: true },
    inBattle: { type: Boolean, required: true },
    bossToFight: { type: Boolean, required: true },
    bossesDefeated: { type: Array, required: true },
    enemyHealth: { type: Number, required: true },
    sfxOn: { type: Boolean, required: true }
  },
  data() {
    return {
      playerTurn: true,
