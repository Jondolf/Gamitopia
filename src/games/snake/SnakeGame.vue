<template>
  <div class="snake-game">
    <StartMenu v-if="currentView === 'Start menu'" @change-current-view="changeCurrentView" />
    <Statistics v-else-if="currentView === 'Statistics'" @change-current-view="changeCurrentView" />
    <Settings
