...
import UpgradeContainer from './UpgradeContainer.vue';
import Cookie from './Cookie.vue';
import SoundControlBtn from './SoundControlBtn.vue';
import ResetProgress from './ResetProgress.vue';
import { Upgrade, PointsPerClick, SpeedOfPointsByTime, AmountOfPointsByTime } from './upgrade';
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      pointInterval: null as number | NodeJS.Timeout | null,
