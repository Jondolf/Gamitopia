...
export default defineComponent({
  ...
  props: {
    pointsPerClick: { type: Object as () => Upgrade, required: true },
    speedOfPointsByTime: { type: Object as () => Upgrade, required: true },
    amountOfPointsByTime: { type: Object as () => Upgrade, required: true }
  },
  ...
  methods: {
    openUpgradesMenu() {
      ...
      this.upgradesMenuOpen ? (upgradeContainer.style.top = '0') : (upgradeContainer.style.top = '90%');
    }
  }
});
</script>
